...
<div class="row">
  <div class="col-md-11" style="float:left; font-size:-1; letter-spacing:-0.5px">[{{ paper.noo }}] {{ paper.title }} </div>
...
<div class="row">
  <div class="col-md-11" style="float:left; font-size:-1; letter-spacing:-0.5px">[{{ paper.no }}] {{ paper.title }} </div>
  <div class="col-md-2" style="text-align:right; font-size:-1; letter-spacing:-0.5px"> <a href="http://arxiv.org/abs/{{ paper.arxivnumber }}">arXiv:{{ paper.arxivnumber }}</a> </div>
</div>
{% endfor %}
</div>
