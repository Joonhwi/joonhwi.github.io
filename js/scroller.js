document.addEventListener('DOMContentLoaded', function() {
  ...
  images.forEach(function(imageSrc, index) {
    ...
    back.innerHTML = `<p style="text-align:center; font-size:110%; display:table-cell; height:150px; vertical-align: middle; margin: 0px; transform: scale(-1, 1); border: 1px solid rgb(255, 0, 0);">` + captions[index] +  `</p>`;
