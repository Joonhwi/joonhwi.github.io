document.addEventListener('DOMContentLoaded', function() {
  ...
  images.forEach(function(imageSrc, index) {
    ...
    back.innerHTML = `<p style="text-align:center; font-size:110%; display:table-cell; width:150px; height:150px; vertical-align: middle; margin: 0px; transform: scale(-1, 1); border: 0.7px solid --text-color;">` + captions[index] +  `</p>`;
